    ...
    <section id="pricing" className="py-16 md:py-24 px-4 bg-white">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {/* Monthly Plan */}
          <div className="bg-white border-2 border-charcoal/10 rounded-3xl p-8 hover:border-teal/30 transition-all hover:shadow-lg">
            <div className="mb-6">
            ...
            <Link href="/auth/signup" className="block">
              <Button className="w-full bg-teal hover:bg-teal/90 text-white py-6 rounded-full text-lg font-medium">
                Start Free Trial
              </Button>
            </Link>
          </div>
          ...
          {/* Annual Plan */}
          <div className="bg-gradient-to-br from-teal to-teal-dark text-white rounded-3xl p-8 relative hover:shadow-2xl transition-all transform hover:-translate-y-1">
            ...
            <Link href="/auth/signup?plan=annual" className="block">
              <Button className="w-full bg-white text-teal hover:bg-white/90 py-6 rounded-full text-lg font-medium">
                Start Free Trial
              </Button>
            </Link>
          </div>
        ...
        <p className="text-center text-charcoal/60 mt-8 max-w-2xl mx-auto">
